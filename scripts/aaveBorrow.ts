...
async function main() {
	...
	*/
	...
	// 3.1 Check the amount I can borrow
	...
	const amountDaiToBorrow =
		availableBorrowsETH.toString() * 0.95 * reciprocalOfDaiPrice // borrow 95% of available borrows and multiply by reciprocal of dai price (95% of 1.65ETH)
	...
	console.log('amountDAIToBorrowWei wei: ', amountDAIToBorrowWei.toString()) //24040847005161808000 (extra 16zeros)
	...
	// 3.3 check borrow data after borrowing successfully.
	await getBorrowUserData(lendingPool, deployer)
...
async function approveErc20(
	...
	console.log('erc20 contract address: ', erc20Token.address)

	// why I can successfully approve a very large amount of tokens when the erc20 token contract is wethTokenAddress in mainet?
	// is it because I just fork the WETH contract?
